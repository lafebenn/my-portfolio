...
import { Globe, Code2, Zap, Layers } from "lucide-react";
  ...
  const projects = [
    ...
    },
    {
      ...
      image: "https://www.globalhubportal.org/api/images/og-logo.png",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1664351363957-b88337cddf48?q=80&w=2070&auto=format&fit=crop",
      type: "code" as ProjectType,
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1658203897339-0b8c64a42fba?q=80&w=2062&auto=format&fit=crop",
      type: "automation" as ProjectType,
